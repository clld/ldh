...
<ul>
    ...
    <li>It will ensure long-term accessibility of your work through a stable URL.</li>
    <li>Your work will be citeable through a persistent identifier.</li>
</ul>
<p>More information about the scientific goals of this project is available in the section describing the <a
        title="Go to page: objectives" href="/objective/">objectives</a> and details about the open access licensing can
    be found in the section <a title="Go to page: for authors" href="/for-authors/">for authors</a>. You can also
    immediately download the <a title="Permission form" href="http://ldh.clld.org/for-authors/permission-form/"
                                target="_blank">permission form </a>to contribute your work to the LDH Project.</p>
<p>The scientific contributions that are available in the Language Description Heritage library are stored in the <a
        title="about: repository" href="/about/repository/">publication repository</a> of the Max Planck Society. This
    repository assures the longevity and stability of the resources. Technically speaking, the website that you are
    currently looking at is only an announcement platform to enhance the visibility of your work. One consequence is
